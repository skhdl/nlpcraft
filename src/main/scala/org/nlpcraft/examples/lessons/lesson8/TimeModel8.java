 ...
 */
public class TimeModel8 extends NCModelProviderAdapter {
     ...
     */
    TimeModel8() throws NCException {
        String path = "src/main/scala/org/nlpcraft/examples/lessons/lesson8/time_model8.json";

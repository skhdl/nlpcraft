...
public class NCDumpWriter {
     ...
     * @throws NCException
     */
    public static File write(NCModel mdl, NCIntentSolver solver, String dir) throws NCException {
        return NCDumpWriterScala.write(mdl, solver, dir);
    }
}

...
public interface NCTokenSqlAdapter<T> {
     ...
     *
     * @return Part of SQL syntax.
     */
    String getClause();

    /**
     * Gets list parameters corresponding to {@link #getClause()} statement.
     *
     * @return List parameters corresponding to {@link #getClause()} statement.
     */
    List<T> getClauseParameters();
}

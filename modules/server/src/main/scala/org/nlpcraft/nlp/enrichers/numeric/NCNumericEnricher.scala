...
import org.nlpcraft.nlp.numeric.{NCNumericUnit, NCNumericsManager}
import org.nlpcraft.nlp.{NCCoreNlp, NCNlpSentence, NCNlpSentenceNote, NCNlpSentenceToken}

import scala.collection._

/**
 * DataLingvo numericd enricher.
 */
object NCNumericEnricher extends NCNlpEnricher("NUMERIC enricher") {
    ...
    private final val NUM_PREFIX_STOPS = NCCoreNlp.stemmatizeSeq(Seq(
        "is",
        "was",
        "were",
        "are",
    ...
    override def enrich(ns: NCNlpSentence) {
        val nums = NCNumericsManager.find(ns)

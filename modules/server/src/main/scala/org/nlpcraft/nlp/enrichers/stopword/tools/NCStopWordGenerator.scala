...
package org.nlpcraft.nlp.enrichers.stopword.tools

import org.nlpcraft._
import org.nlpcraft.nlp.NCCoreNlp
...
object NCStopWordGenerator extends App {
    ...
    private def mkGzip(path: String, lines: Traversable[Any]): Unit = {
        val p = NCGlobals.mkPath(s"modules/nlpsrv/src/main/resources/stopwords/$path")

        G.mkTextFile(p, lines)
        G.gzipPath(p)
    }
